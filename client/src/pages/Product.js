                ...
                <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-16">
                    <div class="w-full lg:sticky top-0 text-center">
                        <div class="lg:h-[560px]">
                            <img src={item.image} alt="Product" class="lg:w-11/12 w-full h-full rounded-md object-cover object-top" />
                        </div>

                        <div class="flex flex-wrap gap-4 justify-center mx-auto mt-4">
                            <img src={item.image} alt="Product1" class="w-16 cursor-pointer rounded-md outline" />
                            <img src={item.image} alt="Product2" class="w-16 cursor-pointer rounded-md" />
                            <img src={item.image} alt="Product3" class="w-16 cursor-pointer rounded-md" />
                            <img src={item.image} alt="Product4" class="w-16 cursor-pointer rounded-md" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-4 items-start">
                            <div>
                                <p class="text-gray-800 text-4xl font-bold">${item.price}</p>
